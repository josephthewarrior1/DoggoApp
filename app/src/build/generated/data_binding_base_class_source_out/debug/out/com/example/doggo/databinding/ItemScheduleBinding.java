...
public final class ItemScheduleBinding implements ViewBinding {
  ...
  private ItemScheduleBinding(@NonNull LinearLayout rootView,
      @NonNull TextView tvScheduleDescription, @NonNull TextView tvScheduleTime) {
    this.rootView = rootView;
    this.tvScheduleDescription = tvScheduleDescription;
  ...
  public static ItemScheduleBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.tvScheduleDescription;
      TextView tvScheduleDescription = ViewBindings.findChildViewById(rootView, id);
      if (tvScheduleDescription == null) {
        break missingId;
      }
      ...
      return new ItemScheduleBinding((LinearLayout) rootView, tvScheduleDescription,
          tvScheduleTime);
    }
